...
footer.href = "https://www.instagram.com/ahsinainan_naim/";

document.querySelector(".tombol").addEventListener("click", function () {
  Swal.fire("Hallo Cantikk", "Aku ada sesuatu nih buat kamu?", "question").then(function () {
    Swal.fire("Tapi kamu jawab yang jujur ya!").then(function () {
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        const { value: name } = Swal.fire({
          ...
          const pertanyaan = Swal.fire({
            title: `Hai ${nama}, denger" kamu lagi ultah ya?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`Yess benerr`).then(function () {
                Swal.fire({
                  title: "Umur berapa emang sekarang?",
                  icon: "question",
                  input: "number",
                  inputLabel: "",
                  inputAttributes: {
              ...
              Swal.fire(`Yakin????`, "", "error").then(function () {
